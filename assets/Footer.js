import { e as createAstro, c as createComponent, m as maybeRenderHead, d as addAttribute, s as spreadAttributes, f as renderSlot, r as renderTemplate, a as renderComponent } from './astro/server.js';
import 'kleur/colors';
/* empty css               */
import 'clsx';
...
}, "/Users/gangshuanfan/Documents/Astro/HarryFan.github.io/src/components/HeaderLink.astro", void 0);

const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header data-astro-cid-3ef6ksr2> <nav data-astro-cid-3ef6ksr2> <h2 data-astro-cid-3ef6ksr2><a${addAttribute(`${"/"}blog/`, "href")} data-astro-cid-3ef6ksr2>${SITE_TITLE}</a></h2> <div class="internal-links" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/blog/", "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`Blog` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/styles", "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`風格圖鑑` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/today", "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`互動作品` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/about/", "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`About` })} </div> <div class="social-links" data-astro-cid-3ef6ksr2> ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/resume/", "data-astro-cid-3ef6ksr2": true }, { "default": ($$result2) => renderTemplate`Resume` })} </div> </nav> </header> `;
}, "/Users/gangshuanfan/Documents/Astro/HarryFan.github.io/src/components/Header.astro", void 0);
...
}, "/Users/gangshuanfan/Documents/Astro/HarryFan.github.io/src/components/Footer.astro", void 0);
