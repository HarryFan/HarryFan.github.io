...
<video src="/works/scroll-world-coffee-demo.mp4" autoplay muted loop playsinline controls preload="metadata" style="width:100%;border-radius:12px;display:block;" aria-label="scroll-world-coffee 捲動刷放示範錄影"></video>

*↑ 實際捲動效果錄影：從咖啡果一路飛到成品咖啡（28 秒）*

線上示範：[/demos/scroll-world-coffee/](/demos/scroll-world-coffee/index.html)（附[製作指南](/demos/scroll-world-coffee/guide/index.html)）。技術拆解全文見 [捲動就是駕駛鏡頭：我用「影片刷放」做了一個從咖啡果飛到咖啡杯的網站](/blog/2026-07-13-scroll-world-video-scrub/)。
