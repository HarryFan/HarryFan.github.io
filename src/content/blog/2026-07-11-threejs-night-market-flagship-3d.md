---
title: '單檔 Three.js 也能做高質感：我把士林夜市小吃重寫成程序化 3D 滾動網站'
...
零資產這條看起來像自虐，但它其實是整個專案的重點：一顆章魚燒長什麼樣，全部是用程式碼「捏」出來的，包含那層濕亮的醬、鐵盤的拉絲反光、會飄的柴魚片。這篇就記錄我怎麼把其中一站（章魚燒）從能動的原型，打磨到我自己盡力做到的程度。老實說，純網頁的即時 3D 跟 Blender 那種離線渲染還是很難比，我不敢說多厲害，只能說在「單檔零資產」這個自我設限底下，這是我目前能做到的最好。先看一段成品：

<video controls autoplay muted loop playsinline width="100%">
  <source src="/videos/takoyaki-scroll-demo.mp4" type="video/mp4">
  您的瀏覽器不支援 video 標籤。
</video>
...
這些沒有一個是「效果」，但少了任何一個，這頁在真實裝置上就是個會發燙、會卡、關不掉的東西。**高質感的一半，其實是這些看不到的護欄。**

## 八、方法論：為什麼我只先打磨一站

最後講一下做法上的取捨，因為這比任何一段 shader 都值錢。

五站的量擺在那，最直覺的做法是五站一起往前推。我沒有——**我只把章魚燒一站打磨到頂**。原因是：在你把一站做到「高質感」之前，你根本不知道高質感長什麼樣、需要哪些參數、會踩到哪些雷。先鋪量，等於把還沒驗證的規格複製五份，之後每改一個決定都要改五個地方。
